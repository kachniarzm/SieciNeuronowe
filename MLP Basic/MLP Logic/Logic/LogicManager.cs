...
namespace MLP_Logic.Logic
{
    public class LogicManager
    {
        ...
        public ResultDTO RunSync(NeuronNetworkDTO neuronNetworkDto, IProgress<int> progressFunction)
        {
        ...
        {
            return await Task.Run(() => RunSync(neuronNetworkDto, progressFunction));
        }
